...
void USART1_IRQHandler(void)
{
  /* USER CODE BEGIN USART1_IRQn 0 */
    ...
    if (__HAL_UART_GET_FLAG(&huart1, UART_FLAG_IDLE) != RESET)
    {
        ...
        /* 获取本次接收到的字节数与数据缓冲区地址, 并重新设置 DMA 的传输数量
            1. 失能 DMA
        ...
        uint16_t receive_length = USART1_BUFF_SIZE - __HAL_DMA_GET_COUNTER(huart1.hdmarx);
        ...
        /* 进入接收回调函数 */
        UARTx_RxCallback(&huart1, p_receive_buff, receive_length);
    }
